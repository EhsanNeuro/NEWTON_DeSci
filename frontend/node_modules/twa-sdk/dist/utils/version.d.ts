import { PostEventName } from 'twa-bridge';
import { Version } from 'twa-core';
export declare type SupportsFunc<Method extends string> = (method: Method) => boolean;
/**
 ...
 */
export declare function createSupportsFunc<Method extends string>(version: Version, schema: Record<Method, PostEventName>): SupportsFunc<Method>;
