 ...
 */
export declare type QRScannerEventName = keyof QRScannerEventsMap;
/**
 * Listener for specified QRScanner event.
 */
export declare type QRScannerEventListener<E extends QRScannerEventName> = QRScannerEventsMap[E];
