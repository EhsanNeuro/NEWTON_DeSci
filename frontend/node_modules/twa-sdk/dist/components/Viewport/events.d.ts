 ...
 */
export declare type ViewportEventName = keyof ViewportEventsMap;
/**
 * Listener for specified Viewport event.
 */
export declare type ViewportEventListener<E extends ViewportEventName> = ViewportEventsMap[E];
