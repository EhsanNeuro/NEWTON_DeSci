 ...
 */
export declare type ClosingConfirmationEventName = keyof ClosingConfirmationEventsMap;
/**
 * Listener for specified ClosingConfirmation event.
 */
export declare type ClosingConfirmationEventListener<E extends ClosingConfirmationEventName> = ClosingConfirmationEventsMap[E];
