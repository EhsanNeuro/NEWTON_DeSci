 ...
 */
export declare type MainButtonEventName = keyof MainButtonEventsMap;
/**
 * Listener for specified MainButton event.
 */
export declare type MainButtonEventListener<E extends MainButtonEventName> = MainButtonEventsMap[E];
