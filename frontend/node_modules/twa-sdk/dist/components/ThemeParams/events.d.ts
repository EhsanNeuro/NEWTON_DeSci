 ...
 */
export declare type ThemeParamsEventName = keyof ThemeParamsEventsMap;
/**
 * Listener for specified ThemeParams event.
 */
export declare type ThemeParamsEventListener<E extends ThemeParamsEventName> = ThemeParamsEventsMap[E];
