...
const Yo = (t) => {
  const e = Vt(), n = Vt(!0), o = j(), r = j(!0), s = Jo(!0), a = Mt(ie({
...
const Ko = $("rgb", (t) => On(j()(t))), Zo = $(
  ...
  (t) => {
    const e = Ko(!0);
    return Object.entries(Tn(t)).reduce((n, [o, r]) => (n[Wo(o)] = e(r), n), {});
  }
);
// @__NO_SIDE_EFFECTS__
function Xo(t) {
...
function Ni(t) {
  ...
  return s.set("tgWebAppPlatform", t.platform), s.set("tgWebAppThemeParams", /* @__PURE__ */ Xo(t.themeParams)), s.set("tgWebAppVersion", t.version), e && s.set("tgWebAppData", e), n && s.set("tgWebAppStartParam", n), typeof o == "boolean" && s.set("tgWebAppShowSettings", o ? "1" : "0"), typeof r == "boolean" && s.set("tgWebAppBotInline", r ? "1" : "0"), s.toString();
}
function tr(t, e) {
  return $("array", (n) => {
    let o;
...
const pr = O("rgb", (t) => ur(A()(t))), lr = O(
  ...
  (t) => {
    const e = pr(!0);
    return Object.entries(Nn(t)).reduce((n, [o, r]) => (n[er(o)] = e(r), n), {});
  }
);
// @__NO_SIDE_EFFECTS__
function jn(t) {
...
function Br(t) {
  const e = window, [, n] = Z(
    ...
    he(e, "message", (o) => {
      ...
      const { eventType: s, eventData: a } = r, i = Rr[s];
      try {
        const p = i ? i()(a) : a;
...
function De(t, e) {
  ...
  if (mr())
    return n.parent.postMessage(o, Dr());
  const { external: r } = n;
...
function qi(t) {
  ...
  window.TelegramWebviewProxy = {
    postEvent(r, s) {
      Nr(n.themeParams, JSON.stringify({ eventType: r, eventData: s })), o == null || o(r, s);
    }
...
function Ur(t, e) {
  ...
  const n = typeof e == "function" ? e : (o) => {
    ...
    let a, i;
    if ("param" in o ? (a = `Parameter "${o.param}" of "${r}" method is unsupported in Mini Apps version ${s}`, i = kr) : (a = `Method "${r}" is unsupported in Mini Apps version ${s}`, i = Pr), e === "strict")
      throw new l(i, a);
    return console.warn(a);
  };
  return (o, r) => z(o, t) ? fr(r) && o === "web_app_set_header_color" && "color" in r && !z(o, "color", t) ? n({ version: t, method: o, param: "color" }) : De(o, r) : n({ version: t, method: o });
}
function qr(t, e, n, o) {
