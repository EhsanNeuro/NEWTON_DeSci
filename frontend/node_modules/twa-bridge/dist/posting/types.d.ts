...
import { ImpactHapticFeedback, NotificationHapticFeedback, SelectionHapticFeedback } from './haptic';
/**
 * Color key which could be used tot update header color.
 */
export declare type HeaderColorKey = 'bg_color' | 'secondary_bg_color';
/**
...
export interface PostEventParamsMap {
     ...
     */
    web_app_trigger_haptic_feedback: ImpactHapticFeedback | NotificationHapticFeedback | SelectionHapticFeedback;
    /**
     * Opens QR scanner.
     * @since Web App version 6.4+
     */
 ...
 */
export declare type PostEventName = keyof PostEventParamsMap;
/**
 * Returns parameters for specified post-available event.
 */
export declare type PostEventParams<E extends PostEventName> = PostEventParamsMap[E];
/**
 * Any post-available event name which does not require arguments.
 */
export declare type PostEmptyEventName = {
    [E in PostEventName]: IsNever<PostEventParams<E>> extends true ? E : never;
}[PostEventName];
/**
 * Any post-available event name which require arguments.
 */
export declare type PostNonEmptyEventName = Exclude<PostEventName, PostEmptyEventName>;
